...
class ReposControllerTest < ActionController::TestCase
  ...
  test "should create repo" do
    assert_difference('Repo.count') do
      post :create, repo: { description: @repo.description, html_url: @repo.html_url, name: @repo.name }
    end
  ...
  test "should update repo" do
    patch :update, id: @repo, repo: { description: @repo.description, html_url: @repo.html_url, name: @repo.name }
    assert_redirected_to repo_path(assigns(:repo))
  end
